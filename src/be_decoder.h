...
#define INS_MASK(pos, bits)     ((binstruction)((1 << (bits)) - 1) << (pos))    /**< INS_MASK */
#define INS_GETx(i, mask, pos)  cast_int(((binstruction)(i) & (mask)) >> (pos)) /**< INS_GETx */
#define INS_SETx(v, mask, pos)  (((binstruction)(v) << (pos)) & (mask))         /**< INS_SETx */
...
/* get field */
#define IGET_OP(i)              cast(bopcode, INS_GETx(i, IOP_MASK, IOP_POS))   /**< IGET_OP */
